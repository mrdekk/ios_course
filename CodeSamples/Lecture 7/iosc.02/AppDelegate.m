...
{
	UIWindow* _window;
	RssChannelViewController* _ctrl;
}
...
-( void ) didSucceededLoadRSS: ( RSS* )rss
{
	...
	_ctrl.Channel = [ rss.Channels objectAtIndex: 0 ];
}
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
	...
	_ctrl = [ [ RssChannelViewController alloc ] initWithNibName: @"RssChannelViewController" bundle: [ NSBundle mainBundle ] ];
